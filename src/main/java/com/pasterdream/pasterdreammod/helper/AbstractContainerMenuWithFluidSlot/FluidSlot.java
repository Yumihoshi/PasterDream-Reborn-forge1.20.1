...
public class FluidSlot
{
    ...
    {
        //throw new RuntimeException("fluidSlotIndex = " + fluidSlotIndex + "获取getMaxCapacity()，container.getMaxFluidCapacity(fluidSlotIndex) = " + container.getMaxFluidCapacity(fluidSlotIndex));
