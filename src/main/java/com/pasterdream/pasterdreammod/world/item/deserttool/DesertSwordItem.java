...
public class DesertSwordItem extends SwordItem {
    ...
    public DesertSwordItem(Tier tier, int damage, float speed, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.pasterdreammod.desert_sword.1"));
        tooltip.add(Component.translatable("tooltip.pasterdreammod.desert_sword.2"));
    }
}
