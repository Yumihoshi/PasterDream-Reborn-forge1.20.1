...
public class ModDeepTreasureLootTablesProvider implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
                ...
                LootTable.lootTable()
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(Items.HEART_OF_THE_SEA)
                                        .setWeight(1)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.ELDER_GUARDIAN_SCALE.get())
                                        .setWeight(1)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(ModItems.DREAM_FERTILIZER.get())
                                        .setWeight(1)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                                .add(LootItem.lootTableItem(ModItems.DYEDREAM_BUD_NUGGET.get())
                                        .setWeight(2)
        ...
        consumer.accept(
                ResourceLocation.fromNamespaceAndPath(PasterDreamMod.MOD_ID, "chests/shadow_deep_sea_treasure"),
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                .setBonusRolls(ConstantValue.exactly(0.1F))
                                .setRolls(ConstantValue.exactly(1.0F))
                                .add(LootItem.lootTableItem(ModItems.SHADOW_SHROOMLIGHT.get())
                                        .setWeight(2)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(ModItems.SHADOW_LIQUID_BUCKET.get())
                                        .setWeight(2)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.SHADOW_BOOKSHELF.get())
                                        .setWeight(2)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.SHADOW_CHEST.get())
                                        .setWeight(1)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE)
                                        .setWeight(1)
        ...
        // ===== 浸影深海秘宝·超级 (shadow_deep_sea_treasure_super) =====
        consumer.accept(
                ResourceLocation.fromNamespaceAndPath(PasterDreamMod.MOD_ID, "chests/shadow_deep_sea_treasure_super"),
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                .setBonusRolls(ConstantValue.exactly(0.1F))
                                .setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(ModItems.SHADOW_BOOKSHELF.get())
                                        .setWeight(3)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.KEY_SHADOW_BOOKSHELF.get())
                                        .setWeight(1)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.COBWEB_SHADOW_BOOKSHELF.get())
                                        .setWeight(2)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(ModItems.WORN_SHADOW_BOOKSHELF.get())
                                        .setWeight(2)
                                        .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))))
                                .add(LootItem.lootTableItem(Items.TRIDENT)
                                        .setWeight(3)
