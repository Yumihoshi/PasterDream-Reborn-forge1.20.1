...
import net.pasterdream.procedures.GoldenFoxPr0Procedure;
...
public class GoldenFoxEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GoldenFoxEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public GoldenFoxEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.GOLDEN_FOX.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GoldenFoxPr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
