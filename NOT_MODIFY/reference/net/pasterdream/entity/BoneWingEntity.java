...
public class BoneWingEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public BoneWingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.BONE_WING.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = BoneWingEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = BoneWingEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = BoneWingEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}
		});
		this.goalSelector.addGoal(3, new RandomLookAroundGoal(this));
		this.goalSelector.addGoal(1, new BoneWingEntity.RangedAttackGoal(this, 1.25, 85, 12f) {
			@Override
