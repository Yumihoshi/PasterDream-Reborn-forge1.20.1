...
import net.pasterdream.procedures.TerrorbeakPr2Procedure;
import net.pasterdream.procedures.TerrorbeakPr1Procedure;
import net.pasterdream.procedures.TerrorbeakPr0Procedure;
...
public class TerrorbeakEntity extends Monster implements GeoEntity {
	...
	public TerrorbeakEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.TERRORBEAK.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PasterdreamModBlocks.THICK_SHADOW_BLOCK.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		TerrorbeakPr2Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public void die(DamageSource source) {
		super.die(source);
		TerrorbeakPr0Procedure.execute(source.getEntity());
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		TerrorbeakPr1Procedure.execute(sourceentity);
	}

	public static void init() {
		SpawnPlacements.register(PasterdreamModEntities.TERRORBEAK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 10) {
			this.remove(TerrorbeakEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
