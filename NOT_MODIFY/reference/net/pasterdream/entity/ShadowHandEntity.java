...
import net.pasterdream.procedures.ShadowHandPr0Procedure;
...
public class ShadowHandEntity extends Monster implements GeoEntity {
	...
	public ShadowHandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.SHADOW_HAND.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Goal() {
			...
			public boolean canContinueToUse() {
				return ShadowHandEntity.this.getMoveControl().hasWanted() && ShadowHandEntity.this.getTarget() != null && ShadowHandEntity.this.getTarget().isAlive();
			}

			@Override
			public void start() {
				LivingEntity livingentity = ShadowHandEntity.this.getTarget();
			...
			public void tick() {
				LivingEntity livingentity = ShadowHandEntity.this.getTarget();
				if (ShadowHandEntity.this.getBoundingBox().intersects(livingentity.getBoundingBox())) {
					ShadowHandEntity.this.doHurtTarget(livingentity);
				} else {
					double d0 = ShadowHandEntity.this.distanceToSqr(livingentity);
					if (d0 < 16) {
						Vec3 vec3d = livingentity.getEyePosition(1);
						ShadowHandEntity.this.moveControl.setWantedPosition(vec3d.x, vec3d.y, vec3d.z, 1.4);
					}
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = ShadowHandEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = ShadowHandEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = ShadowHandEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public boolean hurt(DamageSource source, float amount) {
		ShadowHandPr0Procedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(PasterdreamModEntities.SHADOW_HAND.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
