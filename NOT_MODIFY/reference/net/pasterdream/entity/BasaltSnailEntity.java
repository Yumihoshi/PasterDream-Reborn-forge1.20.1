...
import net.pasterdream.procedures.BasaltSnailPr0Procedure;
...
public class BasaltSnailEntity extends PathfinderMob implements GeoEntity {
	...
	public BasaltSnailEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.BASALT_SNAIL.get(), world);
	}

	public BasaltSnailEntity(EntityType<BasaltSnailEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "basalt_snail");
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		BasaltSnailPr0Procedure.execute(this.level(), this);
	...
	public static void init() {
		SpawnPlacements.register(PasterdreamModEntities.BASALT_SNAIL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BasaltSnailEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
