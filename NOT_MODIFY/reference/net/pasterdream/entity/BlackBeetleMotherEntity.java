...
import net.pasterdream.procedures.BlackBeetleMotherPr0Procedure;
...
public class BlackBeetleMotherEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BlackBeetleMotherEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public BlackBeetleMotherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.BLACK_BEETLE_MOTHER.get(), world);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pasterdream:beetle_attack"));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		BlackBeetleMotherPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BlackBeetleMotherEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
