...
import net.pasterdream.procedures.CrazyTerrorbeakPr2Procedure;
import net.pasterdream.procedures.CrazyTerrorbeakPr1Procedure;
import net.pasterdream.procedures.CrazyTerrorbeakPr0Procedure;
...
public class CrazyTerrorbeakEntity extends Monster implements GeoEntity {
	...
	public CrazyTerrorbeakEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.CRAZY_TERRORBEAK.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		CrazyTerrorbeakPr2Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public void die(DamageSource source) {
		super.die(source);
		CrazyTerrorbeakPr0Procedure.execute(source.getEntity());
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		CrazyTerrorbeakPr1Procedure.execute(sourceentity);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CrazyTerrorbeakEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
