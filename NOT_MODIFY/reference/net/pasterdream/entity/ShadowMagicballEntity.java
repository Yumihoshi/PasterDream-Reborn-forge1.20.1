...
import net.pasterdream.procedures.ShadowMagicballPr2Procedure;
import net.pasterdream.procedures.ShadowMagicballPr0Procedure;
...
public class ShadowMagicballEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShadowMagicballEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public ShadowMagicballEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.SHADOW_MAGICBALL.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ShadowMagicballPr2Procedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ShadowMagicballPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowMagicballEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
