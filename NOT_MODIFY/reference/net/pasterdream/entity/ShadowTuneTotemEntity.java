...
import net.pasterdream.procedures.ShadowTuneTotemPr1Procedure;
import net.pasterdream.procedures.ShadowTuneTotemPr0Procedure;
...
public class ShadowTuneTotemEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShadowTuneTotemEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public ShadowTuneTotemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.SHADOW_TUNE_TOTEM.get(), world);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate_bricks.break"));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ShadowTuneTotemPr0Procedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ShadowTuneTotemPr1Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowTuneTotemEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
