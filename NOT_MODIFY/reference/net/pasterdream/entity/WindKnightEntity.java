...
import net.pasterdream.procedures.WindKnightPr0Procedure;
...
public class WindKnightEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(WindKnightEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public WindKnightEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.WIND_KNIGHT.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		WindKnightPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
