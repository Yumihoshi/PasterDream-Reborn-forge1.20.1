...
import net.pasterdream.procedures.ForsakensWingPr0Procedure;
import net.pasterdream.init.PasterdreamModItems;
import net.pasterdream.client.renderer.ForsakensWingArmorRenderer;
...
public class ForsakensWingItem extends ArmorItem implements GeoItem {
	...
	public ForsakensWingItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (itemstack.getItem() instanceof ForsakensWingItem armor && armor.getType() == ArmorItem.Type.CHESTPLATE) {
			list.add(Component.literal("\u00A77\u25AA \u00A79\u83B7\u5F97\u98DE\u884C\u80FD\u529B\u4E14\u514D\u75AB\u6454\u843D\u4F24\u5BB3"));
			list.add(Component.literal("\u00A77\u25AA \u00A79\u514D\u75AB\u7F13\u6162\u4E0E\u51CB\u96F6\u6548\u679C"));
			list.add(Component.literal("\u00A77\u00A7o-- \u6211\u4EEC\u65F6\u7A7A\u67A2\u7EBD\u89C1"));
		}
	}
	...
	public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
		if (itemstack.getItem() instanceof ForsakensWingItem armor && armor.getType() == ArmorItem.Type.CHESTPLATE)
			ForsakensWingPr0Procedure.execute(world, entity);
	}
