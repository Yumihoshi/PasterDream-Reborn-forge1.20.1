...
import net.pasterdream.item.model.DreamMeterItemModel;
...
public class DreamMeterItemRenderer extends GeoItemRenderer<DreamMeterItem> {
	...
	@Override
	public void actuallyRender(PoseStack matrixStackIn, DreamMeterItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
	...
	@Override
	public void renderRecursively(PoseStack stack, DreamMeterItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
