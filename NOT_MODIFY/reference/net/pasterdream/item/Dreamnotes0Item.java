...
import net.pasterdream.item.inventory.Dreamnotes0InventoryCapability;
...
public class Dreamnotes0Item extends Item {
	public Dreamnotes0Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A76\u5F00\u53D1\u8005\u540D\u5355"));
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Dreamnotes 0");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new Dreamnotes0InventoryCapability();
	}
