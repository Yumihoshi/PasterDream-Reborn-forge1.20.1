...
import net.pasterdream.procedures.StorageBagGuiPr1Procedure;
...
public class StorageBagGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StorageBagGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PasterdreamModMenus.STORAGE_BAG_GUI.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof StorageBagGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			StorageBagGuiPr1Procedure.execute(entity);
		}
	}
}
