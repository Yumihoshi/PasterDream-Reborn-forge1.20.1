...
public class GoldenFoxSculptureTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public GoldenFoxSculptureTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.GOLDEN_FOX_SCULPTURE.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<GoldenFoxSculptureTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<GoldenFoxSculptureTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("golden_fox_sculpture");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Golden Fox Sculpture");
	}
