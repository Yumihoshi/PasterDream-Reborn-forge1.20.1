...
public class WorkshopBlastBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(5, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WorkshopBlastBlockEntity(BlockPos position, BlockState state) {
		super(PasterdreamModBlockEntities.WORKSHOP_BLAST.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("workshop_blast");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new WorkshopBlastGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
