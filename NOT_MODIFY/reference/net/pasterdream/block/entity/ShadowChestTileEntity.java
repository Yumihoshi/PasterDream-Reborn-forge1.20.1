...
public class ShadowChestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public ShadowChestTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.SHADOW_CHEST.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ShadowChestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ShadowChestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("shadow_chest");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ShadowChestGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Shadow Chest");
	}
