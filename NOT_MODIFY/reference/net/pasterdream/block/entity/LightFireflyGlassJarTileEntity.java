...
public class LightFireflyGlassJarTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LightFireflyGlassJarTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.LIGHT_FIREFLY_GLASS_JAR.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LightFireflyGlassJarTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LightFireflyGlassJarTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("light_firefly_glass_jar");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Light Firefly Glass Jar");
	}
