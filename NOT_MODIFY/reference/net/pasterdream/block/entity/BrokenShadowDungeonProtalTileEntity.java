...
public class BrokenShadowDungeonProtalTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BrokenShadowDungeonProtalTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.BROKEN_SHADOW_DUNGEON_PROTAL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BrokenShadowDungeonProtalTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BrokenShadowDungeonProtalTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("broken_shadow_dungeon_protal");
	}
