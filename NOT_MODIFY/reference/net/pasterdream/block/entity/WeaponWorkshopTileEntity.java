...
public class WeaponWorkshopTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public WeaponWorkshopTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.WEAPON_WORKSHOP.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WeaponWorkshopTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WeaponWorkshopTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("weapon_workshop");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new WeaponWorkshopGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
