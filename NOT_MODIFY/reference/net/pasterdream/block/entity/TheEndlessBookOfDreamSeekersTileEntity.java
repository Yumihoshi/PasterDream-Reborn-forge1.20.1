...
public class TheEndlessBookOfDreamSeekersTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(2, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TheEndlessBookOfDreamSeekersTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.THE_ENDLESS_BOOK_OF_DREAM_SEEKERS.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TheEndlessBookOfDreamSeekersTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TheEndlessBookOfDreamSeekersTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("the_endless_book_of_dream_seekers");
	}
	...
	public Component getDisplayName() {
		return Component.literal("The Endless Book Of Dream Seekers");
	}
