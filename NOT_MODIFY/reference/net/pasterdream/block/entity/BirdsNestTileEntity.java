...
public class BirdsNestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BirdsNestTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.BIRDS_NEST.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BirdsNestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BirdsNestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("birds_nest");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Birds Nest");
	}
