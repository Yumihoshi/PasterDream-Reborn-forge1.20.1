...
public class DesertHeroTombTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DesertHeroTombTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.DESERT_HERO_TOMB.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DesertHeroTombTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DesertHeroTombTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("desert_hero_tomb");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Desert Hero Tomb");
	}
