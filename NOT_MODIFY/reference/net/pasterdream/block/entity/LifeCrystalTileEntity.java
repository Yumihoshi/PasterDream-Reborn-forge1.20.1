...
public class LifeCrystalTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LifeCrystalTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.LIFE_CRYSTAL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LifeCrystalTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LifeCrystalTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("life_crystal");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Life Crystal");
	}
