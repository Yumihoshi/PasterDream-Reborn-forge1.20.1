...
public class ResearchTableTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public ResearchTableTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.RESEARCH_TABLE.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ResearchTableTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ResearchTableTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
