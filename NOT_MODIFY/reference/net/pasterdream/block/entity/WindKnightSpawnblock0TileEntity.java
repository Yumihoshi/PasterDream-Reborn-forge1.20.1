...
public class WindKnightSpawnblock0TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WindKnightSpawnblock0TileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.WIND_KNIGHT_SPAWNBLOCK_0.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WindKnightSpawnblock0TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WindKnightSpawnblock0TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("wind_knight_spawnblock_0");
	}
