...
public class UuzDoll0TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public UuzDoll0TileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.UUZ_DOLL_0.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<UuzDoll0TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<UuzDoll0TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("uuz_doll_0");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Uuz Doll 0");
	}
