...
public class HighvoltageThundercloudPr0Procedure {
	public static void execute(LevelAccessor levelAccessor, double x, double y, double z, Entity entity) {
		...
		if (world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y - 10), z), 24, 24, 24), e -> true).isEmpty()) return;
		...
		for (int index = 0; index < 6; index++) {
			...
			entityToSpawn.setBaseDamage(10);
