...
public class Crop4aPr0Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == PasterdreamModItems.PLIERS.get()
			...
			}
			{
				...
				BlockState _bs = PasterdreamModBlocks.CROP_4B.get().defaultBlockState();
			...
			if (world instanceof ServerLevel _level) {
				ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), new ItemStack(PasterdreamModItems.COTTON.get()));
