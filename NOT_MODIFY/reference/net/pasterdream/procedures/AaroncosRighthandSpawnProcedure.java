...
public class AaroncosRighthandSpawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof AaroncosRighthand0Entity) {
			((AaroncosRighthand0Entity) entity).setAnimation("spawn");
		}
		...
		PasterdreamMod.queueServerWork(47, () -> {
			...
			if (world instanceof Level _level && !_level.isClientSide())
				_level.explode(null, (entity.getX()), (entity.getY() + 1), (entity.getZ()), 3, Level.ExplosionInteraction.MOB);
		});
		PasterdreamMod.queueServerWork(51, () -> {
