...
import net.pasterdream.entity.model.JellyfishModel;
...
public class JellyfishRenderer extends GeoEntityRenderer<JellyfishEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, JellyfishEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
	...
	@Override
	protected float getDeathMaxRotation(JellyfishEntity entityLivingBaseIn) {
		return 0.0F;
	}
}
