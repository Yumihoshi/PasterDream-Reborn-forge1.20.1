...
import net.pasterdream.item.model.ForsakensWingModel;
...
public class ForsakensWingArmorRenderer extends GeoArmorRenderer<ForsakensWingItem> {
	...
	@Override
	public RenderType getRenderType(ForsakensWingItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
