...
public class MoltengoldWandProjectileRenderer extends EntityRenderer<MoltengoldWandProjectileEntity> {
	...
	public MoltengoldWandProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelfireball_projectile(context.bakeLayer(Modelfireball_projectile.LAYER_LOCATION));
	}

	@Override
	public void render(MoltengoldWandProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MoltengoldWandProjectileEntity entity) {
		return texture;
	}
}
