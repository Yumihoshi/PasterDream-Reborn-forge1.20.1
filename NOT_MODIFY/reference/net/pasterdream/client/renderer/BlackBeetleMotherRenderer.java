...
import net.pasterdream.entity.model.BlackBeetleMotherModel;
...
public class BlackBeetleMotherRenderer extends GeoEntityRenderer<BlackBeetleMotherEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BlackBeetleMotherEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
