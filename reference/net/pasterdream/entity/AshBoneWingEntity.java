...
import net.pasterdream.procedures.BoneWingPr0Procedure;
...
public class AshBoneWingEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public AshBoneWingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.ASH_BONE_WING.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = AshBoneWingEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AshBoneWingEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AshBoneWingEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}
		});
		this.goalSelector.addGoal(3, new RandomLookAroundGoal(this));
		this.goalSelector.addGoal(1, new AshBoneWingEntity.RangedAttackGoal(this, 1.25, 35, 12f) {
			@Override
	...
	public void baseTick() {
		super.baseTick();
		BoneWingPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
