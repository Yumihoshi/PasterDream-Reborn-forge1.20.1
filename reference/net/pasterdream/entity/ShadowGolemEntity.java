...
import net.pasterdream.procedures.ShadowGolemPr1Procedure;
import net.pasterdream.procedures.ShadowGolemPr0Procedure;
...
public class ShadowGolemEntity extends Monster implements GeoEntity {
	...
	public ShadowGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.SHADOW_GOLEM.get(), world);
	}
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate_tiles.fall")), 0.15f, 1);
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate_tiles.break"));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		ShadowGolemPr1Procedure.execute(this);
	...
	public void baseTick() {
		super.baseTick();
		ShadowGolemPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		SpawnPlacements.register(PasterdreamModEntities.SHADOW_GOLEM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowGolemEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
