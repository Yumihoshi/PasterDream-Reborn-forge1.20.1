...
import net.pasterdream.procedures.HighvoltageThundercloudPr2Procedure;
import net.pasterdream.procedures.HighvoltageThundercloudPr1Procedure;
import net.pasterdream.procedures.HighvoltageThundercloudPr0Procedure;
...
public class HighvoltageThundercloudEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HighvoltageThundercloudEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public HighvoltageThundercloudEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.HIGHVOLTAGE_THUNDERCLOUD.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.4, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = HighvoltageThundercloudEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = HighvoltageThundercloudEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = HighvoltageThundercloudEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public boolean hurt(DamageSource source, float amount) {
		HighvoltageThundercloudPr1Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	...
	public void die(DamageSource source) {
		super.die(source);
		HighvoltageThundercloudPr2Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void baseTick() {
		super.baseTick();
		HighvoltageThundercloudPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
		this.refreshDimensions();
	}

	@Override
	public EntityDimensions getDimensions(Pose p_33597_) {
		return super.getDimensions(p_33597_).scale((float) 2.7);
	}
