...
import net.pasterdream.procedures.FireflyPr0Procedure;
...
public class FireflyEntity extends PathfinderMob implements GeoEntity {
	...
	public FireflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.FIREFLY.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		FireflyPr0Procedure.execute(entity, sourceentity, itemstack);
		return retval;
	}
