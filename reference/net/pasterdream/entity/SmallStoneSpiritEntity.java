...
import net.pasterdream.procedures.SmallStoneSpiritPr0Procedure;
...
public class SmallStoneSpiritEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SmallStoneSpiritEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public SmallStoneSpiritEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PasterdreamModEntities.SMALL_STONE_SPIRIT.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate.step"));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		SmallStoneSpiritPr0Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public EntityDimensions getDimensions(Pose p_33597_) {
		...
		return super.getDimensions(p_33597_).scale((float) SmallStoneSpiritPr1Procedure.execute(entity));
	}

	public static void init() {
		SpawnPlacements.register(PasterdreamModEntities.SMALL_STONE_SPIRIT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 24) {
			this.remove(SmallStoneSpiritEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
