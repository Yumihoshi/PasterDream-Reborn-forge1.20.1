...
public class DreamCauldronTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public DreamCauldronTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.DREAM_CAULDRON.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DreamCauldronTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DreamCauldronTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("dream_cauldron");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new DreamCauldronGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Dream Cauldron");
	}
	...
	private final FluidTank fluidTank = new FluidTank(2000, fs -> {
		if (fs.getFluid() == PasterdreamModFluids.MELTDREAM_LIQUID.get())
			return true;
		return false;
	}) {
		@Override
