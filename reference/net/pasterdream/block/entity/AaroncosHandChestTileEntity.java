...
public class AaroncosHandChestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public AaroncosHandChestTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.AARONCOS_HAND_CHEST.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AaroncosHandChestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AaroncosHandChestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("aaroncos_hand_chest");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Aaroncos Hand Chest");
	}
