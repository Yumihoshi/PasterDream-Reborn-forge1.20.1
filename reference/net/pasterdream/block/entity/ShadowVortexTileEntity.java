...
public class ShadowVortexTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ShadowVortexTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.SHADOW_VORTEX.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ShadowVortexTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ShadowVortexTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("shadow_vortex");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Shadow Vortex");
	}
