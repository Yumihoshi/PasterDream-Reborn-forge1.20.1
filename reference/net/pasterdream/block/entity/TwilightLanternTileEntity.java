...
public class TwilightLanternTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TwilightLanternTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.TWILIGHT_LANTERN.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TwilightLanternTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TwilightLanternTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("twilight_lantern");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Twilight Lantern");
	}
