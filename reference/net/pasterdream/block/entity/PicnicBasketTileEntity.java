...
public class PicnicBasketTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public PicnicBasketTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.PICNIC_BASKET.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PicnicBasketTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PicnicBasketTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("picnic_basket");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new PicnicBasketGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
