...
public class GuardCrystalTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public GuardCrystalTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.GUARD_CRYSTAL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<GuardCrystalTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<GuardCrystalTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("guard_crystal");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Guard Crystal");
	}
