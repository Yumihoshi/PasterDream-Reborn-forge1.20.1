...
public class MeltdreamChestOpenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MeltdreamChestOpenTileEntity(BlockPos pos, BlockState state) {
		super(PasterdreamModBlockEntities.MELTDREAM_CHEST_OPEN.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MeltdreamChestOpenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MeltdreamChestOpenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("meltdream_chest_open");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new MeltdreamChestGui0Menu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
