...
public class ElixirBottlePr0Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == PasterdreamModItems.ELIXIR_BOTTLE.get() && entity.level()
			...
			if ((world
					...
					.createLegacyBlock()).getBlock() == PasterdreamModBlocks.MELTDREAM_LIQUID.get()) {
				if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(PasterdreamModItems.ELIXIR_BOTTLE.get());
				...
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(PasterdreamModItems.MELTDREAM_ELIXIR_BOTTLE.get());
