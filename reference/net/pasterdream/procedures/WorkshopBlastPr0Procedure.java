...
public class WorkshopBlastPr0Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 2)).getItem() == Items.LAVA_BUCKET && new Object() {
		...
		}.getFluidTankCapacity(world, BlockPos.containing(x, y, z), 1)) {
			{
				...
				int _amount = 1000;
				if (_ent != null)
					_ent.getCapability(ForgeCapabilities.FLUID_HANDLER, null).ifPresent(capability -> capability.fill(new FluidStack(Fluids.LAVA, _amount), IFluidHandler.FluidAction.EXECUTE));
			}
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
				if (_ent != null) {
